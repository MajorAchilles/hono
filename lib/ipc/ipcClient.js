...
import { printCenter } from "../utils/terminal";
...
const sendCommand = (command, params) => {
  ...
  ipc.connectTo(
    ...
    () => {
      ...
      ipc.of.hono.on(EVENTS.IPC.TABLE, handleTable);
      ipc.of.hono.on(EVENTS.IPC.GENERIC, handleMessage);
    }
  );
};
